  ...
  useEffect(()=>{
    ...
    return (
      ...
      <>
        ...
        <Text style={styles.header} >Live Sensors Data</Text>
             <Card 
              style={{ marginTop:20,
              borderRadius: 16,
              marginBottom: 10,
            ...
            <Text style={styles.header} >PH-Sensor Data  {store.ph[store.ph.length -1]} </Text>
       ...
       <Card 
              ...
              <>
              <Text style={styles.header} >Temperature-Sensor Data {store.temp[store.temp.length - 1]}</Text>
         <LineChart
           data={{
           //labels: ['January', 'February', 'March', 'April', 'May', 'June'],
             datasets: [
       ...
       <Card 
              ...
              <>
              <Text style={styles.header} >Turbidity-Sensor Data {store.tb[store.tb.length - 1]}</Text>
         <LineChart
           data={{
           labels: ['January', 'February', 'March', 'April', 'May', 'June'],
             datasets: [
